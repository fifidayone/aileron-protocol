...
[![Designed For Gemini Agent](https://img.shields.io/badge/Designed_For-Gemini_Agent-FF6B00?style=for-the-badge&logo=google-gemini&logoColor=white)](https://gemini.google.com/)
...
| :--- | :--- | :--- |
| [⚡ Lite](Aileron/lite/GEMINI.md) | Quick fixes, exploration | Speed and staying out of the way — does what's asked, skips overplanning, lets the model move. |
| [⚖️ Balanced](Aileron/balanced/GEMINI.md) | Everyday feature work | Sensible balance — reads enough surrounding code to avoid shallow fixes, plans only when the work needs it. |
| [🎨 Studio](Aileron/studio/GEMINI.md) | UI work and design polish | How the result looks and behaves on screen — composition, hierarchy, motion, viewing the rendered output. |
| [🏗️ Architect](Aileron/architect/GEMINI.md) | System changes with real risk | Understanding the system before changing it — blast radius, callers, contracts, recovery paths. |
| [👑 Ultimate](Aileron/ultimate/GEMINI.md) | High-stakes production work | Maximum coverage: polished UI, solid code, resilient systems. |
