...
- Load skills, MCP schemas, or search_web only when named, clearly relevant, current/external knowledge is needed, or local context is insufficient. Skip invoke_subagent unless clearly needed; if run, do not paste transcripts.
